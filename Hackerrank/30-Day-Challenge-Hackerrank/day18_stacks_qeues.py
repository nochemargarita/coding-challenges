...
characters match, we continue dequeueing, popping, and comparing each character
...
reads a single line containing string s. It then calls the methods specified above
to pass each character to your instance variables.
...
will print 'The word, s, is a palindrome';
